        ...
        @foreach($roles as $role)
            <tr>
                ...
                <td class="d-flex justify-content-around">
                    <div class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#editRoleModal_{{$role->id}}"><i class="bi bi-pencil-square"></i> </div>
                    <div class="cursor-pointer"  data-bs-toggle="modal" data-bs-target="#addPermissionsModal_{{$role->id}}"><i class="bi bi-cash-coin"></i></div>
            ...
            @include('content/role/permissions-list-modal', ['role' => $role])
        @endforeach
    </tbody>
    </table>
