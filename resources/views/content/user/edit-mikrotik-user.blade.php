    ...
    <div class="card-body">
        <form action="{{route('user-store-mikrotik-customer')}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="reg_date" name="reg_date" placeholder="Registration Date" />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" placeholder="User Name" value="{{$user->name}}"/>
            </div>
            <div class="mb-3">
